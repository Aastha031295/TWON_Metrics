...
UNI_MODELS = [
    # LLama (MetaAI)
    "llama3.1:8b-instruct-q6_K", #0 
    "llama3.3:70b-instruct-q6_K", #1
    "mistral:7b-instruct-v0.2-q6_K", #2
    "mixtral:8x7b-instruct-v0.1-q6_K", #3
    "phi4:latest", #4
    "deepseek-r1:70b" #5
]   
# Configuration
...
OUTPUT_FOLDER = "output_new" # Folder to save the output CSV files